...
public  class DropDownAreaAdapter extends BaseAdapter {
    ...
    public DropDownAreaAdapter(Context context, List<AreaList> datas) {
    ...
    public void fillValue(int position, ViewHolder holder) {
        AreaList areaList = list.get(position);
        holder.tvId.setText(areaList.getPL_AREA_LABEL());
        holder.tvName.setText(areaList.getPL_AREA_NAME());

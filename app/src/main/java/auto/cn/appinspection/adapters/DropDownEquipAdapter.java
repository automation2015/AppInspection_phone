...
public  class DropDownEquipAdapter extends BaseAdapter {
    private Context context;
    private List<Equiplist> list;
    ...
    public DropDownEquipAdapter(Context context, List<Equiplist> datas) {
    ...
    public void fillValue(int position, ViewHolder holder) {
        Equiplist equiplist = list.get(position);
        holder.tvId.setText(equiplist.getEL_NAME());
        holder.tvName.setText(equiplist.getEL_EIS_NAME());

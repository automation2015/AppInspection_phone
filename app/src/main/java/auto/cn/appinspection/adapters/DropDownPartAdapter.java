...
public  class DropDownPartAdapter extends BaseAdapter {
    private Context context;
    private List<PartList> list;
    ...
    public DropDownPartAdapter(Context context, List<PartList> datas) {
    ...
    public void fillValue(int position, ViewHolder holder) {
        PartList partList = list.get(position);
        holder.tvId.setText(partList.getPART_ID());
        holder.tvName.setText(partList.getPART_NAME());

...
public class EquiplistDao extends AbstractDao<Equiplist, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property Fk_area = new Property(9, Long.class, "fk_area", false, "FK_AREA");
    };
    ...
    public Equiplist readEntity(Cursor cursor, int offset) {
        Equiplist entity = new Equiplist( //
            ...
            cursor.isNull(offset + 9) ? null : cursor.getLong(offset + 9) // fk_area
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, Equiplist entity, int offset) {
        ...
        entity.setFk_area(cursor.isNull(offset + 9) ? null : cursor.getLong(offset + 9));
     }
